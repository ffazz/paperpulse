module.exports = [
"[project]/.next-internal/server/app/api/user/lists/[listId]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/user/lists/[listId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (isPublic !== undefined) {
            ...
            if (isPublic && !list.shareSlug) {
                const { nanoid } = await __turbopack_context__.A("[project]/node_modules/nanoid/index.js [app-route] (ecmascript, async loader)");
                updateData.shareSlug = nanoid(8);
            }
        }
        const updatedList = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].readingList.update({
            where: {
                id: listId
            },
            data: updateData,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedList);
    } catch (error) {
...
async function DELETE(request, { params }) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].readingList.delete({
            where: {
                id: listId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c72d8280._.js.map