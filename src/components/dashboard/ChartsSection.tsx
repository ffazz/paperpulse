...
export default function ChartsSection({ insights }: ChartsSectionProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-12 md:mt-16">
      ...
      >
        <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-4 md:mb-6">Top Subjects</h3>
          ...
          {genreData.length > 0 ? (
            genreData.map((genre, index) => (
              <div key={index} className="space-y-1 md:space-y-2">
                ...
                <div className="w-full bg-midnight/10 rounded-full h-2 md:h-3 overflow-hidden">
                  <motion.div
                    initial={{ width: 0 }}
            ...
            <div className="text-center py-8 md:py-12 text-midnight/60 text-sm">
      ...
      <motion.div
        ...
        className="bg-white rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 shadow-lg"
      >
        <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-4 md:mb-6">Language Distribution</h3>
        <div className="space-y-3 md:space-y-4">
